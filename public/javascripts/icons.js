/* Shared inline SVG icon set — mirrors lib/icons.js so server-rendered and
   client-rendered markup use identical icons. Loaded before app.js. */
(function () {
  'use strict';

  var ATTRS = 'viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"';

  window.BeautiqueIcons = {
